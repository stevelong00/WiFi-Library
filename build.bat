...
%WINDIR%\Microsoft.NET\Framework\v4.0.30319\msbuild ManagedWifi.sln /p:Configuration="%config%;VersionNumber="%version%" /m /v:M /fl /flp:LogFile=msbuild.log;Verbosity=diag /nr:false
